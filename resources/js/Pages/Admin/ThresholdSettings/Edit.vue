<template>
    <AdminLayout>
        <Head title="Edit Pengaturan Threshold" />
            ...
            <Card>
                <CardHeader>
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <CardTitle class="text-2xl">Edit Pengaturan Threshold</CardTitle>
                            <CardDescription>
                                Edit pengaturan threshold "{{ threshold.label }}"
                            </CardDescription>
                        </div>
                    </div>
                </CardHeader>
                        ...
                        <div class="flex justify-between pt-6 border-t">
                            ...
                            <div class="flex gap-4">
                                ...
                                <Button type="submit" :disabled="form.processing">
                                    ...
                                    {{ form.processing ? 'Menyimpan...' : 'Update Threshold' }}
                                </Button>
                            </div>
                        </div>
                    </form>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Apakah Anda yakin ingin menghapus threshold "{{ threshold.label }}"?
                        <br><br>
                        Tindakan ini tidak dapat dibatalkan dan akan mempengaruhi sistem monitoring.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
...
const form = useForm({
    ...
    label: props.threshold.label,
    water_level: props.threshold.water_level,
    color: props.threshold.color,
    severity: props.threshold.severity,
    description: props.threshold.description,
    is_active: props.threshold.is_active,
})

const submit = () => {
    form.put(route('admin.threshold-settings.update', props.threshold.id))
}
...
const deleteThreshold = () => {
    router.delete(route('admin.threshold-settings.destroy', props.threshold.id))
